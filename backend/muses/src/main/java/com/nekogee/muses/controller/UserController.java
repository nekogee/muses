...
public class UserController {
    ...
    public SysUser join(@RequestParam("username") String username,
                        @RequestParam("alias") String alias,
                        @RequestParam("password") String password) {

        SysUser sysUser = new SysUser(username, alias, password);
        sysUser.setCryptPassword();
    ...
    public SysUser getUser(@RequestParam("id") long uid) {
